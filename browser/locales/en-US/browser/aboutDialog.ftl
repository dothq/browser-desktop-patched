...
community-2 = This browser is made possible by the <label data-l10n-name="community-firefoxLink">Firefox open-source project</label> and <label data-l10n-name="community-contributorsLink">its contributors</label>.

helpus = Want to help? <label data-l10n-name="helpus-donateLink">Make a donation to Mozilla</label> or <label data-l10n-name="helpus-getInvolvedLink">get involved!</label>
